...
def eval_link_prediction(model, triples_loader, text_dataset, entities, relations,
    ...
    while idx < num_relations:
        ...
        if isinstance(model, models.BertNode2Vec) or isinstance(model, models.BOWNode2Vec) or isinstance(model, models.DKRLNode2Vec):
            ...
            batch_emb = model(text_tok_rel.unsqueeze(1).to(device),
                              text_mask_rel.unsqueeze(1).to(device))
