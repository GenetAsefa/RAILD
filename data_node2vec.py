...
class TextGraphDataset(GraphDataset):
    ...
    def collate_fn(self, data_list):
        ...
        return text_tok_ent, text_mask_ent, relation_features, rels, neg_idx
...
def test_text_graph_dataset():
    ...
    gtr = TextGraphDataset('data/test-data/ind-train.tsv', max_len=32,
                           neg_samples=64, tokenizer=tok, drop_stopwords=False,
